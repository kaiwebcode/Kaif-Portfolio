...
const FeedbackCard = ({
  ...
  <motion.div
    ...
    className="bg-slate-700 p-6 rounded-3xl xs:w-[320px] w-full"
  >
...
const Feedbacks = () => {
  return (
    <div className="mt-8 bg-slate-800 rounded-[20px]">
      <div className={`bg-slate-900 border-b-2 rounded-2xl ${styles.padding} min-h-[300px]`}>
